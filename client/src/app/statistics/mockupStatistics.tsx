...
const topScorers: PlayerStats[] = [
  { id: 1, name: "Robgol", team: inter, goals: 19 },
  { id: 2, name: "Robinho", team: thunder, goals: 12 },
  { id: 3, name: "João Pedro", team: atletico, goals: 7 },
  { id: 7, name: "Kleberson", team: golden, goals: 7 },
  { id: 4, name: "Alef", team: dalas, goals: 6 },
  { id: 5, name: "Ítalo", team: thunder, goals: 6 },
  { id: 24, name: "Zulim", team: lions, goals: 5 },
  ...
  { id: 25, name: "Evanuel", team: lions, goals: 4 },
  { id: 16, name: "Thiago", team: inter, goals: 4 },
  { id: 14, name: "Eduardo", team: atletico, goals: 4 },
  { id: 15, name: "Dudu", team: dalas, goals: 4 },
  { id: 26, name: "Moris", team: inter, goals: 3 },
...
const cards: CardStats[] = [
  { id: 20, name: "KLEBERSON", team: golden, yellow: 2, red: 1 },
...
const teams: TeamStats[] = [
  ...
  { id: 2, name: "CM Inter Miami", goalsScored: 30, goalsConceded: 11 },
