...
export const news: NewsItem[] = [
  ...
  {
    id: 6,
    title: "🔥 2ª RODADA ENCERRADA!",
    date: "11/07/2025",
    summary:
      "A segunda rodada terminou com tudo! Teve show dentro de campo, expulsões que agitaram a torcida e até vitória por W.O. A disputa está cada vez mais acirrada e a emoção não para! Fique ligado... a próxima rodada promete! 📅",
  },
  {
    id: 7,
    title: "🟥 CRISE NO CA NOTTS! 😱",
    date: "11/07/2025",
    summary:
      "A situação ficou complicada para o CA NOTTS, a equipe não compareceu para a partida da 2ª rodada e acabou sofrendo uma derrota por W.O. Falta de jogadores? Problemas internos? A torcida quer respostas! Enquanto isso, o time adversário saiu com os 3 pontos sem nem precisar entrar em campo. ",
  },
  {
    id: 8,
    title: "⚠️ TG FC sofre nova derrota",
    date: "11/07/2025",
    summary:
